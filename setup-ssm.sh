...
read -p "GOOGLE_CALENDAR_IDS (comma separated): " GOOGLE_CALENDAR_IDS
...
aws ssm put-parameter --name /maki-daily-report/GOOGLE_CALENDAR_IDS --value "$GOOGLE_CALENDAR_IDS" --type String --profile $PROFILE
